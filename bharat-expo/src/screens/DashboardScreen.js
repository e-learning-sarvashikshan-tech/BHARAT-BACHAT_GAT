...
const DashboardScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Quick Actions Section - Fixed 2-Row Layout */}
      ...
      {/* Row 2 */}
      <View style={[styles.actionGrid, { marginTop: 0 }]}>
        ...
        <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate('MeetingMinutes')}>
          <View style={styles.iconCircle}>
            <Ionicons name="document-text-outline" size={30} color="#2952a3" />
          </View>
          <Text style={styles.actionText}>Records</Text>
        </TouchableOpacity>

        {/* Empty view to keep the grid aligned properly */}
