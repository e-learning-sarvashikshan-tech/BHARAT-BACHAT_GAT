      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <View style={styles.iconBox}>
            <Ionicons name="pie-chart" size={20} color="#2952a3" />
          </View>
...
const styles = StyleSheet.create({
  ...
  totalCard: { backgroundColor: '#28a745', padding: 25, borderRadius: 16, marginBottom: 25, alignItems: 'center', elevation: 4 },
  ...
  iconBox: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#eef2f9', justifyContent: 'center', alignItems: 'center' },
  groupName: { fontSize: 16, fontWeight: 'bold', color: '#333' },
  percentageText: { fontSize: 12, color: '#888', marginTop: 2 },
  amountText: { fontSize: 18, fontWeight: 'bold', color: '#2952a3' },
  barBackground: { height: 6, backgroundColor: '#e9ecef', borderRadius: 3, overflow: 'hidden' },
  barFill: { height: '100%', backgroundColor: '#2952a3', borderRadius: 3 },
